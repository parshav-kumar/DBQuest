...
function Landing() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden relative ${
      ...
      >
        <div className={`animate-float-1 border rounded-xl p-6 text-center transform hover:-translate-y-2 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:border-blue-500 ${
        ...
        <div className={`animate-float-2 border rounded-xl p-6 text-center transform hover:-translate-y-2 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:border-purple-500 ${
          theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow-sm'
        }`}>
          <div className="text-4xl mb-3">🤖</div>
        ...
        <div className={`animate-float-3 border rounded-xl p-6 text-center transform hover:-translate-y-2 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:border-green-500 ${
          theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200 shadow-sm'
        }`}>
          <div className="text-4xl mb-3">🏆</div>
      ...
      >
        ...
        <button
          ...
          className={`font-bold py-3 px-8 rounded-xl text-lg transition-all duration-200 hover:scale-105 border ${
            theme === 'dark'
